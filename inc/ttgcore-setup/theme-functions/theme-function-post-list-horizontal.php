...
if(!function_exists( 'wpcast_template_post_list_horizontal' )){
	function wpcast_template_post_list_horizontal( $atts = array() ){
...
if(function_exists('ttg_custom_shortcode')) {
	ttg_custom_shortcode("qt-post-list-horizontal","wpcast_template_post_list_horizontal");
}

/**
 *  Visual Composer integration
 */
add_action( 'vc_before_init', 'wpcast_template_post_list_horizontal_vc' );
if(!function_exists('wpcast_template_post_list_horizontal_vc')){
	function wpcast_template_post_list_horizontal_vc() {
  		vc_map( 
  			array(
				"name" => esc_html__( "Post list - Horizontal", "wpcast" ),
				"base" => "qt-post-list-horizontal",
				"icon" => get_theme_file_uri( '/inc/ttgcore-setup/theme-functions/img/qt-post-list-horizontal.png' ),
				"description" => esc_html__( "List of posts with horizontal design", "wpcast" ),
