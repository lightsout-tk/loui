...
?>
<article id="post-vertical-<?php the_ID(); ?>" <?php post_class('wpcast-post wpcast-post__ver wpcast-paper wpcast-card'); ?>>
	<div class="wpcast-post__header wpcast-darkbg  wpcast-negative">
		<div class="wpcast-bgimg">
			<?php 
			if( has_post_thumbnail() ){
			 the_post_thumbnail( 'wpcast-squared-m', array( 'class' => 'wpcast-post__thumb') );
			}; 
			?>
		</div>
